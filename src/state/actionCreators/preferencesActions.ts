...
import { GetPreferencesAction, SetCurrencyAction, SetThemeAction } from '../actions';
...
export const setCurrency = (id: string): SetCurrencyAction => {
...
export const setTheme = (isDarkTheme: boolean): SetThemeAction => {
